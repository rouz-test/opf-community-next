...
const HeartFilledIcon = forwardRef<SVGSVGElement, HeartFilledIconProps>(
  ({ size = 16, boxSize, color = 'currentColor', ...props }, ref) => {
    ...
    return (
      <svg ref={ref} width={resolvedSize} height={resolvedSize} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden={props['aria-label'] ? undefined : true} focusable="false" {...props}>
