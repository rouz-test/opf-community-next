...
const sidebarItems = [
  { label: '커뮤니티', href: '/mypage/community', icon: MessageSquareText },
  {
    label: '캠퍼스',
    href: '/mypage/campus',
    icon: School,
  ...
  },
  {
    ...
    icon: Settings,
    children: [
      { label: '프로필', href: '/mypage/settings/profile' },
      { label: '프로덕트', href: '/mypage/settings/product' },
      { label: '알림', href: '/mypage/settings/notifications' },
    ],
  },
  { label: '로그아웃', href: '/community', icon: LogOut, isLogout: true },
];
...
export default function MyPageLayout({ children }: { children: React.ReactNode }) {
  ...
  const isSettingsRoute = pathname.startsWith('/mypage/settings');
